...
export class PromptsManager {
  ...
  async spawnAutoPrompts() {
    ...
    const isPageViewConditionMetForNative =
    ...
    const isPushSlidedownConfigured =
      !!PromptsHelper.getFirstSlidedownPromptOptionsWithType(
        (_a = userPromptOptions.slidedown) === null || _a === void 0
          ? void 0
          : _a.prompts,
    ...
    const prompts =
      (_b = userPromptOptions.slidedown) === null || _b === void 0
        ? void 0
        : _b.prompts;
    if (
      !!prompts &&
      (prompts === null || prompts === void 0 ? void 0 : prompts.length) > 0
    ) {
      for (let i = 0; i < prompts.length; i++) {
        ...
        const isPageViewConditionMetForSlidedown = this.isPageViewConditionMet(
  ...
  async internalShowParticularSlidedown(typeToPullFromConfig, options) {
    ...
    const prompts =
      (_b =
        (_a = this.context.appConfig.userConfig.promptOptions) === null ||
        _a === void 0
          ? void 0
    ...
    await this.internalShowSlidedownPrompt(
      Object.assign(Object.assign({}, options), { slidedownPromptOptions })
    );
  }
  installEventHooksForSlidedown() {
    ...
    OneSignal.emitter.on(Slidedown.EVENTS.CANCEL_CLICK, () => {
      ...
      const type =
        (_a = this.context.slidedownManager.slidedown) === null || _a === void 0
          ? void 0
          : _a.options.type;
      switch (type) {
        case DelayedPromptType.Push:
  ...
  getDelayedPromptOptions(promptOptions, type) {
    ...
    switch (type) {
      case DelayedPromptType.Native: {
        ...
        return {
          enabled:
            nativePromptOptions === null || nativePromptOptions === void 0
              ? void 0
              : nativePromptOptions.enabled,
          autoPrompt:
            nativePromptOptions === null || nativePromptOptions === void 0
              ? void 0
              : nativePromptOptions.autoPrompt,
          timeDelay:
            nativePromptOptions === null || nativePromptOptions === void 0
              ? void 0
              : nativePromptOptions.timeDelay,
          pageViews:
            nativePromptOptions === null || nativePromptOptions === void 0
              ? void 0
              : nativePromptOptions.pageViews,
        };
      }
      case DelayedPromptType.Push:
      case DelayedPromptType.Category:
      ...
      case DelayedPromptType.SmsAndEmail: {
        ...
        const options = PromptsHelper.getFirstSlidedownPromptOptionsWithType(
          ((_b =
            (_a = userConfig.promptOptions) === null || _a === void 0
              ? void 0
              : _a.slidedown) === null || _b === void 0
            ? void 0
            : _b.prompts) || [],
        ...
        return {
          enabled: !!options,
          autoPrompt: !!(options === null || options === void 0
            ? void 0
            : options.autoPrompt),
          timeDelay:
            (_c =
