  ...
  var t = {
      967: (t, i) => {
        ...
        Object.defineProperty(i, "__esModule", { value: !0 }),
          (i.isIosSafari =
            i.supportsVapidPush =
            i.supportsSafariLegacyPush =
            i.isPushNotificationsSupported =
              void 0),
      ...
      935: (t, i, o) => {
        ...
        var e = o(967),
          n = (function () {
            function t() {}
            return (
              (t.addScriptToPage = function (t) {
                var i = document.createElement("script");
                (i.src = t), (i.defer = !0), document.head.appendChild(i);
              }),
              ...
              (t.loadFullPageSDK = function () {
                t.addScriptToPage(
                  ""
                    .concat(t.getPathAndPrefix(), "OneSignalSDK.page.es6.js?v=")
                    .concat(t.VERSION)
                );
              }),
              (t.start = function () {
                (0, e.isPushNotificationsSupported)()
                  ? t.loadFullPageSDK()
        ...
        (i.OneSignalShimLoader = n), (n.VERSION = Number(160201));
      },
    },
    i = {};
  function o(e) {
