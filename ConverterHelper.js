...
export class ConverterHelper {
  ...
  static upgradeConfigToVersionTwo(userConfig) {
    ...
    if (
      ...
      if (
        (_b = userConfig.promptOptions) === null || _b === void 0
          ? void 0
          : _b.slidedown
      ) {
        userConfig.promptOptions.slidedown =
          ConverterHelper.convertConfigToVersionTwo(
            (_c = userConfig.promptOptions) === null || _c === void 0
              ? void 0
              : _c.slidedown
          );
      }
  ...
  static convertConfigToVersionTwo(slidedownConfig) {
    ...
    if (promptType === DelayedPromptType.Category) {
      positiveUpdateButton =
        (_a = slidedownConfig.categories) === null || _a === void 0
          ? void 0
          : _a.positiveUpdateButton;
      negativeUpdateButton =
        (_b = slidedownConfig.categories) === null || _b === void 0
          ? void 0
      ...
      prompts: [
        ...existingPromptsConfig,
        {
          ...
          text: {
            ...
            updateMessage:
              (_c =
                slidedownConfig === null || slidedownConfig === void 0
                  ? void 0
                  : slidedownConfig.categories) === null || _c === void 0
                ? void 0
                : _c.updateMessage,
          },
          delay: {
          ...
          categories:
            (_d =
              slidedownConfig === null || slidedownConfig === void 0
                ? void 0
                : slidedownConfig.categories) === null || _d === void 0
              ? void 0
              : _d.tags,
        },
      ],
