...
export class CustomLinkManager {
  ...
  async initialize() {
    ...
    if (
      !((_b = this.config) === null || _b === void 0
        ? void 0
        : _b.unsubscribeEnabled) &&
      isPushEnabled
    ) {
  ...
  async setTextFromPushStatus(element) {
    var _a, _b, _c, _d;
    if (
      (_b = (_a = this.config) === null || _a === void 0 ? void 0 : _a.text) ===
        null || _b === void 0
        ? void 0
        : _b.subscribe
    ) {
    ...
    if (
      (_d = (_c = this.config) === null || _c === void 0 ? void 0 : _c.text) ===
        null || _d === void 0
        ? void 0
        : _d.unsubscribe
    ) {
  ...
  setCustomColors(element) {
    ...
    if (
      !((_a = this.config) === null || _a === void 0 ? void 0 : _a.color) ||
      !this.config.color.text
    ) {
      return;
    }
    if (
      ((_b = this.config) === null || _b === void 0 ? void 0 : _b.style) ===
        "button" &&
      ((_c = this.config) === null || _c === void 0 ? void 0 : _c.color.button)
    ) {
      element.style.backgroundColor =
        (_d = this.config) === null || _d === void 0 ? void 0 : _d.color.button;
      element.style.color =
        (_e = this.config) === null || _e === void 0 ? void 0 : _e.color.text;
    } else if (
      ((_f = this.config) === null || _f === void 0 ? void 0 : _f.style) ===
      "link"
    ) {
      element.style.color =
        (_g = this.config) === null || _g === void 0 ? void 0 : _g.color.text;
    }
  }
