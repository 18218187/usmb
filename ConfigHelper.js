...
(function (IntegrationConfigurationKind) {
  ...
  IntegrationConfigurationKind[
    (IntegrationConfigurationKind["Dashboard"] = 0)
  ] = "Dashboard";
  /**
   * Configuration comes from user-provided JavaScript code only.
   */
  IntegrationConfigurationKind[
    (IntegrationConfigurationKind["JavaScript"] = 1)
  ] = "JavaScript";
...
export class ConfigHelper {
   ...
   */
  static injectDefaultsIntoPromptOptions(
    promptOptions,
    defaultsFromServer,
    wholeUserConfig
  ) {
    ...
    const promptOptionsConfig = Object.assign(
    ...
    if (promptOptionsConfig.slidedown) {
      promptOptionsConfig.slidedown.prompts =
        (_b =
          (_a = promptOptionsConfig.slidedown) === null || _a === void 0
            ? void 0
            : _a.prompts) === null || _b === void 0
          ? void 0
          : _b.map((promptOption) => {
  ...
  static getUserConfigForConfigIntegrationKind(
    configIntegrationKind,
    userConfig,
    serverConfig
  ) {
    ...
    switch (integrationCapabilities.configuration) {
      ...
      case IntegrationConfigurationKind.JavaScript: {
        ...
        const config = Object.assign(
          Object.assign(
            Object.assign(Object.assign({}, userConfig), {
