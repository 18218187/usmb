...
export default class EventHelper {
  ...
  static async checkAndTriggerSubscriptionChanged() {
    ...
    const pushSubscriptionId =
      (_a =
        pushModel === null || pushModel === void 0
          ? void 0
          : pushModel.data) === null || _a === void 0
        ? void 0
        : _a.id;
    ...
    const change = {
      previous: {
        ...
        optedIn:
          lastKnownOptedIn !== null && lastKnownOptedIn !== void 0
            ? lastKnownOptedIn
            : true,
      },
      current: {
  ...
  static async _onSubscriptionChanged(change) {
    ...
    EventHelper.onSubscriptionChanged_showWelcomeNotification(
      (_a = change === null || change === void 0 ? void 0 : change.current) ===
        null || _a === void 0
        ? void 0
        : _a.optedIn,
      (_b = change === null || change === void 0 ? void 0 : change.current) ===
        null || _b === void 0
        ? void 0
        : _b.id
    );
    EventHelper.onSubscriptionChanged_sendCategorySlidedownTags(
      (_c = change === null || change === void 0 ? void 0 : change.current) ===
        null || _c === void 0
        ? void 0
        : _c.optedIn
    );
   ...
   */
  static async onSubscriptionChanged_showWelcomeNotification(
    isSubscribed,
    pushSubscriptionId
  ) {
    var _a;
    ...
    const welcome_notification_opts =
      (_a = OneSignal.config) === null || _a === void 0
        ? void 0
        : _a.userConfig.welcomeNotification;
